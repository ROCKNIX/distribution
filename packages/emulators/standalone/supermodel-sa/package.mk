...
case ${TARGET_ARCH} in
  aarch64|arm)
    ...
    PKG_URL="https://github.com/DirtBagXon/model3emu-code-sinden/archive/${PKG_VERSION}.tar.gz"
    ;;
  *)
...
makeinstall_target() {
  ...
  cp -P ${PKG_BUILD}/bin/supermodel ${INSTALL}/usr/bin/supermodel
  cp -P ${PKG_DIR}/scripts/start_supermodel.sh ${INSTALL}/usr/bin
