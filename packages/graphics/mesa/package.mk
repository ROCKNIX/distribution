...
if listcontains "${GRAPHIC_DRIVERS}" "panfrost"; then
  ...
  if [ "${DEVICE}" = "RK3399" ]; then
  	PKG_VERSION="25.1.1"
  	# This is needed for panfrost on mesa 25.1 and newer.
  	# when bifrost bugs are solved in mesa 25 this case should be merged with the one below
  	PKG_DEPENDS_TARGET+=" mesa:host"
  else
    # Bifrost is broken on newer mesa
    PKG_VERSION="25.1.1"
  fi
...
PKG_URL="https://gitlab.freedesktop.org/mesa/mesa/-/archive/mesa-${PKG_VERSION}/mesa-mesa-${PKG_VERSION}.tar.gz"
#PKG_URL="https://gitlab.freedesktop.org/mesa/mesa/-/archive/main.tar.gz"


pre_configure_host() {
if [[ "${GALLIUM_DRIVERS}" == *"panfrost"* ]]; then
