...
PKG_DEPENDS_TARGET="toolchain glfw"
...
makeinstall_target() {
  ...
  cp ${PKG_BUILD}/.${TARGET_NAME}/target/${RUST_TARGET}/release/liblibrashader_capi.so ${SYSROOT_PREFIX}/usr/lib/librashader.so.2
  ...
  cp ${PKG_BUILD}/.${TARGET_NAME}/target/${RUST_TARGET}/release/liblibrashader_capi.so ${INSTALL}/usr/lib/librashader.so.2
