...
PKG_DEPENDS_TARGET="gamescope lsfg-vk nss networkmanager"
[ "${TARGET_ARCH}" = "aarch64" ] && PKG_DEPENDS_TARGET+=" fex-emu"
...
makeinstall_target() {
  mkdir -p ${INSTALL}/usr
    cp -a ${PKG_BUILD}/usr/bin ${INSTALL}/usr/bin
    cp -a ${PKG_DIR}/scripts/* ${INSTALL}/usr/bin
    cp -a ${PKG_BUILD}/usr/lib ${INSTALL}/usr/lib
