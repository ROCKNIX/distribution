...
git clone git@github.com:yourusername/shared-copilot-knowledge.git /tmp/test-backup
...
git clone git@github.com:yourusername/shared-copilot-knowledge.git
cd shared-copilot-knowledge
...
# Test clone access
git clone git@github.com:yourusername/shared-copilot-knowledge.git /tmp/test
```
