...
### Tools and Utilities Organization
**Purpose-based categorization for development tools:**

```
tools/
├── cleanup/               # Maintenance and cleanup utilities
├── commit_hooks/          # Pre-commit hook implementations
├── maintenance/           # System maintenance tools
├── timestamp/             # Timestamp management utilities
├── tui/                   # Terminal user interface components
└── utilities/             # General-purpose development tools
```

**Utility Management Principles:**
- **Single Source of Truth**: Never duplicate helper functionality across multiple files
- **Check for existing utilities** before creating new ones
- **Refactor duplicate code** into shared utilities
- **Create reusable components** rather than one-off solutions
- **Document utility purposes** and usage patterns

**Each utility directory should contain:**
- **README.md**: Purpose, usage, and examples
- **Individual scripts**: One primary function per file
- **Configuration files**: Settings and exclusion lists as needed
- **Documentation**: Inline help and usage instructions
